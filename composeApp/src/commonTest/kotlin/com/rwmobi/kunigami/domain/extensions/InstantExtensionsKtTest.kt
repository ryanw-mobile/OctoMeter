...
class InstantExtensionsKtTest {
    ...
    fun `toIso8601WithoutSeconds should format correctly`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 30, second = 15).toInstant(TimeZone.UTC)
    ...
    fun `atStartOfHour should round down correctly`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 45, second = 15).toInstant(timeZone)
        val expected = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 0, second = 0).toInstant(timeZone)
    ...
    fun `atStartOfDay should round down to start of day`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 45, second = 15).toInstant(timeZone)
        val expected = LocalDateTime(year = 2023, month = 5, day = 1, hour = 0, minute = 0, second = 0).toInstant(timeZone)
    ...
    fun `atEndOfDay should round up to end of day`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 45, second = 15).toInstant(timeZone)
        val expected = LocalDateTime(year = 2023, month = 5, day = 1, hour = 23, minute = 59, second = 59, nanosecond = 999_999_999).toInstant(timeZone)
    ...
    fun `getNextHalfHourCountdownMillis should return correct millis when current time is exactly on the hour`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 0, second = 0, nanosecond = 0).toInstant(timeZone)
    ...
    fun `getNextHalfHourCountdownMillis should return correct millis when current time is exactly on the half hour`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 30, second = 0, nanosecond = 0).toInstant(timeZone)
        val expected = 30 * 60 * 1000L // 30 minutes in milliseconds
        assertEquals(expected, instant.getNextHalfHourCountdownMillis())
    }
    ...
    fun `getNextHalfHourCountdownMillis should return correct millis when current time is just past the hour`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 1, second = 0, nanosecond = 0).toInstant(timeZone)
    ...
    fun `getNextHalfHourCountdownMillis should return correct millis when current time is just past the half hour`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 31, second = 0, nanosecond = 0).toInstant(timeZone)
        val expected = 29 * 60 * 1000L // 29 minutes in milliseconds
        assertEquals(expected, instant.getNextHalfHourCountdownMillis())
    }
    ...
    fun `getNextHalfHourCountdownMillis should return correct millis when current time is just before the half hour`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 29, second = 30, nanosecond = 0).toInstant(timeZone)
    ...
    fun `getNextHalfHourCountdownMillis should return correct millis when current time is just before the hour`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 59, second = 30, nanosecond = 0).toInstant(timeZone)
        val expected = 30 * 1000L // 30 seconds in milliseconds
        assertEquals(expected, instant.getNextHalfHourCountdownMillis())
    }
    ...
    fun `getNextHalfHourCountdownMillis should return correct millis including nanoseconds`() {
        val instant = LocalDateTime(year = 2023, month = 5, day = 1, hour = 10, minute = 29, second = 59, nanosecond = 999_000_000).toInstant(timeZone)
    ...
    fun `atStartOfDay should return 00 00 local time on a typical day`() {
        val date = LocalDate(year = 2024, month = 6, day = 15) // A typical day, not a transition day
        val expectedStartOfDay = LocalDateTime(year = date.year, month = date.month.number, day = date.day, hour = 0, minute = 0, second = 0)
    ...
    fun `atEndOfDay should return 23 59 59 local time on a typical day`() {
        val date = LocalDate(year = 2024, month = 6, day = 15) // A typical day, not a transition day
        val expectedEndOfDay = LocalDateTime(year = date.year, month = date.month.number, day = date.day, hour = 23, minute = 59, second = 59, nanosecond = 999_999_999)
            .toInstant(londonZone)
    ...
    fun `atStartOfDay should correctly handle the transition from GMT to BST`() {
        ...
        val date = LocalDate(year = 2024, month = 3, day = 31)
        val expectedStartOfDay = LocalDateTime(year = date.year, month = date.month.number, day = date.day, hour = 0, minute = 0, second = 0)
            .toInstant(londonZone)
        val actualStartOfDay = expectedStartOfDay.atStartOfDay()
